...
# After setting the cosmology we can e.g. run the following line to get ten merger trees drawn from Sheth&Tormen
merger_tree.compute_serial(mass = None,                      # mass of the halo today in M_sun/h
                           n_halo_max = 1000000,             # number of maximum halos that can be within a merger tree
                           file_name = 'FirstTreeFile.hdf5', # file_name; has to be set to .hdf5 which is the output-format in classic_trees
                           ...
                           n_tree = 10,                      # number of trees to be computed
