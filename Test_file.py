...
file = 'TreeTest_SageCompSurfaceCalc8.hdf5'
...
# tree.compute_slow(mass=2e15,m_res=1e9,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64))
tree.compute_fast(random_mass='ST',m_max=1e15,m_res=1e9,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64),n_part=10,n_tree=2,file_name=file)
