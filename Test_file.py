...
file = 'TreeTest_FoF_random_10000.hdf5'
...
# set_trees(tree)
# tree.compute_fast(random_mass='ST',times=a,file_name=file,n_part=500,n_tree=20)
...
plt.savefig('TreeTest_NFoF1Nprog_random_4.png')
# plt.show()
