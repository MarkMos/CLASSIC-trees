...
# tree.compute_fast(m_max=1e12,m_min=1e11,random_mass='ST',m_res=1e9,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64),file_name=file,n_part=5,n_tree=20,BoxSize=63.0)
