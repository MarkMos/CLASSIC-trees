...
file = 'SageTest_TwoTrees_differentMassDiffSame_otherself8.0.hdf5'
...
set_trees(tree)
# # tree.comp_speed()
# tree.compute_slow(mass=1e13,m_res=1e9,times='equal z',mode='FoF',vel_base=np.array([100,90,100],dtype=np.float64))#,n_halo_max=1e7)#,file_name=file)
...
tree.compute_fast(mass=np.array([5e13,1e13]),random_mass='Self',m_res=1e9,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64),file_name=file,n_part=1,n_tree=2,BoxSize=63.0)
