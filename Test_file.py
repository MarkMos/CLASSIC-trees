...
set_trees(tree)
# tree.compute_slow(mass=1e13,m_res=1e11,mode='Normal')#,file_name=file)
tree.compute_slow(mass=1e13,m_res=1e8,mode='FoF',vel_base=np.array([100,90,100],dtype=np.float64))#,file_name=file)
