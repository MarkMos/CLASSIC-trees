...
file = 'SageTest_TestTree400_sameMass_5e14.0.hdf5'
...
tree.compute_fast(mass=5e14,m_res=1e9,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64),file_name=file,n_part=40,n_tree=10)
