...
tree.compute_fast(mass=np.array([1e13,5e12]),random_mass='Self',m_res=1e9,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64),file_name=file,n_part=1,n_tree=2,BoxSize=63.0)
