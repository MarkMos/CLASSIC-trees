...
file = 'SageTest_TestTree10000_differentMass_Mmin1e11_Boxsize63.0.hdf5'
...
set_trees(tree)
# # tree.comp_speed()
# tree.compute_slow(mass=1e15,m_res=1e9,times='equal z',mode='FoF',vel_base=np.array([100,90,100],dtype=np.float64))#,n_halo_max=1e7)#,file_name=file)
...
tree.compute_fast(random_mass='ST',m_max=5e14,m_min=1e11,m_res=1e9,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64),file_name=file,n_part=1000,n_tree=10,BoxSize=63.0)
