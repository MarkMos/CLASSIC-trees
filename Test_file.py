...
file = 'SageTest_ThreeTree_2.0.hdf5'
...
set_trees(tree)
# # tree.comp_speed()
# tree.compute_slow(mass=1e13,m_res=1e8,times='equal z',mode='FoF',vel_base=np.array([100,90,100],dtype=np.float64))#,n_halo_max=1e7)#,file_name=file)
