...
set_trees(tree)
# tree.comp_speed()
# tree.compute_slow(mass=1e13,m_res=1e8,mode='Normal',z_max=15,n_lev=20,vel_base=np.array([100,90,100],dtype=np.float64),scaling=3e-1)#,file_name=file)
...
tree.compute_slow(mass=2e15,m_res=1e8,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64))
