...
file = 'SageTest_ThreeTree.0.hdf5'
...
set_trees(tree)
# # tree.comp_speed()
# tree.compute_slow(mass=1e11,m_res=1e8,times='equal z',mode='Normal',vel_base=np.array([100,90,100],dtype=np.float64))#,n_halo_max=1e7)#,file_name=file)
...
tree.compute_fast(mass=1e13,m_res=1e9,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64),file_name=file,n_part=1,n_tree=3)
