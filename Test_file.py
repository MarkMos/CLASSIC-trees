...
file = 'SageTest_TestTree200_differentMass_Mmin1e13_Boxsize63.0.hdf5'
...
tree.compute_fast(random_mass='ST',m_max=5e14,m_min=1e13,m_res=1e9,mode='FoF',z_max=20,n_lev=27,vel_base=np.array([100,90,100],dtype=np.float64),file_name=file,n_part=20,n_tree=10,BoxSize=63.0)
